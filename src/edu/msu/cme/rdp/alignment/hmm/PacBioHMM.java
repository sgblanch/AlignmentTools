...
import static edu.msu.cme.rdp.alignment.hmm.ProfileHMM.msc;
import static edu.msu.cme.rdp.alignment.hmm.TSC.BM;
import static edu.msu.cme.rdp.alignment.hmm.TSC.DD;
import static edu.msu.cme.rdp.alignment.hmm.TSC.DM;
import static edu.msu.cme.rdp.alignment.hmm.TSC.MD;
import static edu.msu.cme.rdp.alignment.hmm.XSC.LOOP;
import static edu.msu.cme.rdp.alignment.hmm.XSC.MOVE;
...
public class PacBioHMM {
    ...
    int index;    // index in the PacBio file
    ...
    int l;
    double maxProbability; //max probability in the whole model for normalize
    ...
    @Override
    public PacBioHMM clone () {
        PacBioHMM copy = new PacBioHMM();
    ...
    public void setAlignedNum(int jj){
        this.alignedNum = jj;    
    }
    ...
    public void viterbiScore( double scoreIs){
        this.viterbiScore = scoreIs;
    }
/*
